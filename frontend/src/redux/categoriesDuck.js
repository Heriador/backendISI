...
export const getCategoriesAction = id => async (dispatch,getState)=> {
    try {
        const res =  await axios.get(`https://catalogo-onlineapi.herokuapp.com/api/categories/all/${id}`);
        dispatch({
...
export const getCategorieAction = (name) => async (dispatch, getState) =>{
    try {
        const res = await axios.get(`https://catalogo-onlineapi.herokuapp.com/api/categories/${name}`);
        dispatch({
...
export const createCategorieAction = (categorie) => async (dispatch, getState) =>{
    try {
        const res = await axios.post(`https://catalogo-onlineapi.herokuapp.com/api/categories/`,categorie);
        console.log(res);
        dispatch({
...
export const updateCategorieAction = (id, file) => async (dispatch, getState) =>{
    try {
        await axios.put(`https://catalogo-onlineapi.herokuapp.com/api/categories/${id}`,file)
        dispatch({
...
export const deleteCategorieAction = (id) => async (dispatch, getState) =>{
    try {
        const res = await axios.delete(`https://catalogo-onlineapi.herokuapp.com/api/categories/${id}`);
        dispatch({
